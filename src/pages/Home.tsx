...
const FEATURED_DESTINATION_TRIPS: Trip[] = [
  ...
  },
  {
    ...
    slug: 'darjeeling-tea-gardens-2024',
  ...
  },
  {
    ...
    slug: 'meghalaya-abode-of-clouds-2025',
                      ...
                      {searchResults.map((trip) => (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <SafeImage src={trip.coverImage} alt={trip.title} className="w-10 h-10 object-cover rounded-lg" />
                            <div>
